...
public class InvalidCourseDurationFileGenerator {
    // Private constructor to prevent instantiation
    private InvalidCourseDurationFileGenerator() {
     ...
     */
    public static MockMultipartFile generateInvalidCourseDurationExcelFile() throws IOException {
        ...
        try (XSSFWorkbook workbook = new XSSFWorkbook()) {
            ...
            durationRow.createCell(1).setCellValue("");
